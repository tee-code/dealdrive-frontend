<template>
    <div>
        <div class="d-flex flex-row justify-content-between">
            ...
            <h1 class="section-title">Users Section</h1>
            ...
            <tr v-for="user in users" :key="user.id">
                ...
                <!-- <td> -->
                   <!-- <div class="button-section"> -->
                        <!-- <button class="info" @click="toggleModal(user.id)">View user</button> -->
                        <!-- <button class="danger" @click="deleteData(team.id)">Delete</button> -->
                     <!-- </div>  -->
                <!-- </td> -->
                 <!-- <BaseModal v-if="showModal && currentModalIndex == user.id" @closeModal="toggleModal(user.id)">
                    <h1 class="title">View user</h1>

                   <div class="p-3">{{ user.user }}</div>
...
console.log(users, ' users before')

store.dispatch('getData', 'users');
